...
/* base.html.twig */
class __TwigTemplate_9a694f49f1688fb04cf1d36534e10fcfda5fc88829d7fb01cc9b9fdee65e18ca extends \Twig\Template
{
...
<html lang=\"fr\">
    ...
    <body>
        ...
        echo "
                ";
        // line 47
        if (( !$this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "user", []) && ("login" != $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "request", []), "attributes", []), "get", [0 => "_route"], "method")))) {
            // line 48
            echo "                <a href=\"";
