...
class __TwigTemplate_deab88e325501a42ec44fd9aa040a6f9f4ecff9e6e99ea370481d307d7bf5f12 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            ...
            echo "</th>
                <td>";
            // line 12
            echo $this->env->getFunction('profiler_dump')->getCallable()($this->env, twig_get_attribute($this->env, $this->source, (isset($context["data"]) || array_key_exists("data", $context) ? $context["data"] : (function () { throw new RuntimeError('Variable "data" does not exist.', 12, $this->source); })()), $context["key"], [], "array", false, false, false, 12));
            echo "</td>
            </tr>
        ";
        }
