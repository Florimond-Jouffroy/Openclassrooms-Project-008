...
class appDevDebugProjectContainer extends Container
{
    ...
    /**
     * Gets the private 'doctrine' shared service.
     *
    ...
    /**
     * Gets the private 'monolog.handler.debug' shared service.
     *
    ...
    protected function getMonolog_Logger_CacheService()
    {
        ...
        $instance->pushHandler(${($_ = isset($this->services['monolog.handler.debug']) ? $this->services['monolog.handler.debug'] : ($this->services['monolog.handler.debug'] = new \Symfony\Bridge\Monolog\Handler\DebugHandler(100, true))) && false ?: '_'});
