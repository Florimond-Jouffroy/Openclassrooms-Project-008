...
class __TwigTemplate_b9c9d891c2541e9fea87f4f58fec5bd2 extends Template
{
    private $source;
    private $macros = [];
...
\t";
    ...
    {
        return array (  196 => 41,  178 => 37,  173 => 35,  169 => 34,  165 => 33,  162 => 32,  145 => 31,  129 => 18,  125 => 17,  122 => 16,  116 => 13,  112 => 11,  109 => 10,  99 => 9,  88 => 6,  78 => 5,  60 => 3,  37 => 1,);
    }
...
\t{% else %}
\t\t<div>
\t\t\t<a href=\"{{path('user_list')}}\" class=\"btn btn-primary mb-3\">Les utilisateurs</a>
\t\t\t<a href=\"{{path('admin_tasks')}}\" class=\"btn btn-outline-primary mb-3\">Les Taches</a>
\t\t</div>
\t\t<div class=\"row\">
\t\t\t<table class=\"table\">
\t\t\t\t<thead>
...
\t\t\t\t\t\t\t<td>{{ user.email }}</td>
\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t<a href=\"{{ path('admin_user_edit', {'id' : user.id}) }}\" class=\"btn btn-success btn-sm\">Edit</a>
\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t{% endfor %}
\t\t\t\t</tbody>
...
\t{% endif %}
{% endblock %}
", "admin/user/users.html.twig", "/home/florimond/code/Florimond-Jouffroy/Openclassrooms-Project-008/templates/admin/user/users.html.twig");
    }
}
