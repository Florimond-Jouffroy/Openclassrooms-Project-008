...
class __TwigTemplate_6380633ffd5b58f46ba90f0e1fde355b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "admin/tasks.html.twig", 1);
    ...
    public function block_header_title($context, array $blocks = [])
    {
        ...
        // line 4
        echo "\t<h1>Liste des taches sans utilisateurs</h1>
";
...
\t\t<a href=\"";
        ...
        echo "\" class=\"btn btn-outline-primary mb-3\">Les utilisateurs</a>
\t\t<a href=\"";
        // line 10
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_tasks");
        echo "\" class=\"btn btn-primary mb-3\">Les Taches</a>
\t</div>
\t<div class=\"tasks\">
\t\t";
        // line 13
        $this->loadTemplate("/partials/_taskList.html.twig", "admin/tasks.html.twig", 13)->display($context);
        // line 14
        echo "\t</div>
...
";
    ...
    {
        return array (  105 => 14,  103 => 13,  97 => 10,  93 => 9,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block header_title %}
\t<h1>Liste des taches sans utilisateurs</h1>
{% endblock %}

{% block body %}
\t<div>
\t\t<a href=\"{{path('user_list')}}\" class=\"btn btn-outline-primary mb-3\">Les utilisateurs</a>
\t\t<a href=\"{{path('admin_tasks')}}\" class=\"btn btn-primary mb-3\">Les Taches</a>
\t</div>
\t<div class=\"tasks\">
...
{% endblock %}
", "admin/tasks.html.twig", "/home/florimond/code/Florimond-Jouffroy/Openclassrooms-Project-008/templates/admin/tasks.html.twig");
    }
}
